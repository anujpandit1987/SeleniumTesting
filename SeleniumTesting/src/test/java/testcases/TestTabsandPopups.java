	...
	public static void main(String[] args) {
		...
		System.out.println("----Generating window ids from first window----");
		 Set<String> winids = driver.getWindowHandles(); 
		  ...
		  driver.findElement(By.xpath("/html/body/div[1]/div/div[2]/div[1]/div/div/div/div[3]/div/div[3]/div/div/button")).click();
		  ...
		  System.out.println(iterate.next()); // first window String second_window =
		  String second_window = iterate.next(); // second window System.out.println(second_window);
		  ...
		  contains("JetPrivilege HDFC Bank Signature"));
		  
		  driver.close(); //3rd window driver.switchTo().window(second_window);
		  driver.close();
